<?php /* Smarty version Smarty-3.1.8, created on 2016-01-29 06:07:12
         compiled from "application/views/contents/products/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20569556235576c552664e68-20323778%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5e43eca646e51a3b8c8670dbc71c62b7134da3e1' => 
    array (
  ...
  'nocache_hash' => '20569556235576c552664e68-20323778',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_5576c55295ebb8_74290682',
  'variables' => 
  array (
    'title' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_5576c55295ebb8_74290682')) {function content_5576c55295ebb8_74290682($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_capitalize')) include '/home2/amazings/public_html/VUfinder/application/third_party/Smarty-3.1.8/libs/plugins/modifier.capitalize.php';
...
?>
        ...
        <ul>
            ...
            <p><center><img  class='products-image' src='<?php echo site_url();?>
public/img/products/<?php echo $_smarty_tpl->tpl_vars['product']->value['image'];?>
...
products/<?php echo $_smarty_tpl->tpl_vars['product']->value['cat_machine'];?>
...
public/img/V.png " alt="" width="15%"/></span>

                </button>


                <button onclick="window.location = '<?php echo site_url();?>
...
public/js/lib/jquery.js"></script>
    ...
    audioElement.setAttribute('src', '<?php echo site_url();?>
public/mp3/flash-audio.mp3');

<?php /* Smarty version Smarty-3.1.8, created on 2016-01-31 12:53:03
         compiled from "application/views/contents/products/items.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13999541675576c5557aab36-71450285%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e4002ebf81ac7103153b282162282fabc1b80aa9' => 
    array (
      0 => 'application/views/contents/products/items.tpl',
      1 => 1454016989,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '13999541675576c5557aab36-71450285',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_5576c556031016_58499698',
  'variables' => 
  array (
    'title' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_5576c556031016_58499698')) {function content_5576c556031016_58499698($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_capitalize')) include '/home2/amazings/public_html/VUfinder/application/third_party/Smarty-3.1.8/libs/plugins/modifier.capitalize.php';
...
public/img/products/<?php echo $_smarty_tpl->tpl_vars['items']->value['image'];?>
" alt=""  width="400px;"/></p >
...
$</b></p>
            ...
            <p class="products-btn centerall"> <button class="add_to_cart k<?php echo $_smarty_tpl->tpl_vars['items']->value['id'];?>
 disable-class"  data-btn='<?php echo $_smarty_tpl->tpl_vars['items']->value['id'];?>
' >Add to cart..</button> <button onclick="window.location = '<?php echo site_url();?>
cart/checkout/'">checkout</button>    </p>
    ...
    <div class="overview">
        ...
        <div class="content1">
            <?php if (!empty($_smarty_tpl->tpl_vars['spec']->value['overview'])) {?><?php echo $_smarty_tpl->tpl_vars['spec']->value['overview'];?>
 <?php }?>
        </div>
        <div class="content2">
            <?php if (!empty($_smarty_tpl->tpl_vars['spec']->value['key_features'])) {?><?php echo $_smarty_tpl->tpl_vars['spec']->value['key_features'];?>
 <?php }?>

        </div>
        <div class="content3">
            <?php if (!empty($_smarty_tpl->tpl_vars['spec']->value['specs'])) {?><?php echo $_smarty_tpl->tpl_vars['spec']->value['specs'];?>
 <?php }?>
        </div>
                </div>
    </div>

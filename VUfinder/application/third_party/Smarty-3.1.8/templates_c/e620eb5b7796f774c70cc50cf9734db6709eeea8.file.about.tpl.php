<?php /* Smarty version Smarty-3.1.8, created on 2017-01-17 13:44:28
         compiled from "application\views\contents\about.tpl" */ ?>
<?php /*%%SmartyHeaderCode:539754e8e405ee36b8-07959040%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e620eb5b7796f774c70cc50cf9734db6709eeea8' => 
    array (
      0 => 'application\\views\\contents\\about.tpl',
      1 => 1484650330,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '539754e8e405ee36b8-07959040',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_54e8e4060703f4_50431188',
  'variables' => 
  array (
    'title' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_54e8e4060703f4_50431188')) {function content_54e8e4060703f4_50431188($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_capitalize')) include 'E:\\Projects\\Private\\ServerSide\\CodeIgniter\\VUfinder\\application\\third_party\\Smarty-3.1.8\\libs\\plugins\\modifier.capitalize.php';
...
<html lang="en">
    ...
    <div class="about">
        ...
        <div class="article_about">
            ...
            <p>
                viewFinder, opened their original namesake shop with one employee, in Tel aviv, in 1995. They sold
                film,cameras, and processing materials. What started out as a small storefront and black and white ads
                in photography magazines, grew into our larger store at 17th Street which attracted a loyal customer
                base of photo, video, and audio professionals.In the early days of mail-order, when few could be
                trusted,
                viewFinder developed a reputation for honesty and genuine products, and the business grew by word of
                mouth. viewFinder's business continued to grow into the diverse and engaging company we are today,
                serving customers worldwide on our popular and highly rated website.
            </p>
        </div>
        ...
        <div class="article_about">
            ...
            <p>
                We are committed to providing you with extraordinary service before, during, and after your purchase
                from us. You are invited to call us, chat with us, or visit us at our SuperStore, where we are happy
                to serve and assist you every step of the way.
                Our sales professionals have many years of prior experience in their respective fields. ViewFinder
                maintains a formal training department to help keep them up to date with the latest technologies and
                products, so that we can answer every question to your satisfaction. Our staff is at your disposal,
                always happy to offer advice based on experience and knowledge.

                Our customers count on us to maintain ample stock of our industries' full product lines, from highly
                popular brands and products to obscure, hard-to-find accessories and solutions, to satisfy their
                diverse professions and requirements. And finally, on our website, our mobile apps, our call centers,
                and at our store, we are committed to always providing you the fair and competitive pricing you have
                come to expect from ViewFinder.
            </p>
        </div>
    </div>
</article>

<?php /* Smarty version Smarty-3.1.8, created on 2016-02-16 01:07:02
         compiled from "application/views/contents/cms/welcome_dash.tpl" */ ?>
<?php /*%%SmartyHeaderCode:750159919557dbaefe5b561-10821879%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd79f96a4e9eae95fe381357307b0efb6d17f020a' => 
    array (
  ...
  'nocache_hash' => '750159919557dbaefe5b561-10821879',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_557dbaf02ef6d5_79608058',
  'variables' => 
  array (
    'title' => 0,
    'uri_site5' => 0,
...
<?php if ($_valid && !is_callable('content_557dbaf02ef6d5_79608058')) {function content_557dbaf02ef6d5_79608058($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home2/amazings/public_html/VUfinder/application/third_party/Smarty-3.1.8/libs/plugins/modifier.replace.php';
...
cms/dashboard/<?php echo $_smarty_tpl->tpl_vars['v']->value;?>
_management">Edit</a></td>
                        
                    <?php } elseif (preg_match('/orders/',$_smarty_tpl->tpl_vars['v']->value)) {?>
                        <td>
                            <a href="<?php echo site_url();?>
cms/dashboard/<?php echo smarty_modifier_regex_replace($_smarty_tpl->tpl_vars['v']->value,'/(view_finder_)/','');?>
_summery">Edit</a>
                        </td>
                    ...
                    <?php } else { ?>
                        <td>
                            <a href="<?php echo site_url();?>
cms/dashboard/<?php echo smarty_modifier_regex_replace($_smarty_tpl->tpl_vars['v']->value,"/(view_finder_)|(s)"."$"."/",'');?>
_management">Edit
                        </td>
                    <?php }?>
